...
"""Train CUT baseline for **rgb2ir** (RGB → IR, 3-band → 1-band, 1024×1024).

Usage::

    # Single GPU
    python -m examples.cut.train_rgb2ir

    # Multi-GPU via accelerate
    accelerate launch -m examples.cut.train_rgb2ir --train_batch_size 4
...
from .config import rgb2ir_config, TaskConfig  # noqa: E402
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train CUT – rgb2ir")
