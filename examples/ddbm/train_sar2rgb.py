...
"""Train DDBM baseline for **sar2rgb** (SAR → RGB, 1-band → 3-band, 1024×1024).
...
Usage::
    ...
    accelerate launch -m examples.ddbm.train_sar2rgb --train_batch_size 4
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DDBM – sar2rgb")
...
def main():
    ...
    # For example:  cfg.num_res_blocks = 3
    # ------------------------------------------------------------------
