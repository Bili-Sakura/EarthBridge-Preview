...
"""Train DDBM baseline for **sar2eo** (SAR → EO, 1-band 256×256).
...
Usage::
    ...
    accelerate launch -m examples.ddbm.train_sar2eo --train_batch_size 64
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DDBM – sar2eo")
