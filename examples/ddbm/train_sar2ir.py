...
"""Train DDBM baseline for **sar2ir** (SAR → IR, 1-band → 1-band, 1024×1024).
...
Usage::
    ...
    accelerate launch -m examples.ddbm.train_sar2ir --train_batch_size 4
...
def parse_overrides() -> dict:
    parser = argparse.ArgumentParser(description="Train DDBM – sar2ir")
...
def main():
    ...
    # For example:  cfg.num_channels = 192
    # ------------------------------------------------------------------
