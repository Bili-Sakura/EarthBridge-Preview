#!/usr/bin/env bash
# EXP-0222 — DBIM — SAR→RGB stage A: runtime random-crop 1024->512
#
# Usage:
#   bash scripts/EXP_0222_SAR2RGB_MULTIRES/train_dbim_sar2rgb_512_8gpu.sh
#   NGPU=8 bash scripts/EXP_0222_SAR2RGB_MULTIRES/train_dbim_sar2rgb_512_8gpu.sh
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2rgb_512_8gpu.log"
mkdir -p "${LOG_DIR}"
