#!/usr/bin/env bash
# DBIM-Pixel-Medium-0216 — RGB→IR — Pixel-space DBIM (no VAE)
...
#   CUDA_VISIBLE_DEVICES=0 bash scripts/DBIM_Pixel_Medium-0216/train_rgb2ir.sh
#   # (pick 0-3 to spread stages across 4 GPUs)
#   # or multi-GPU:
#   NGPU=4 bash scripts/DBIM_Pixel_Medium-0216/train_rgb2ir.sh
...
NGPU="${NGPU:-1}"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/train_rgb2ir_dbim.log"
...
OUTPUT_DIR="./ckpt/DBIM_Pixel_Medium-0216/rgb2ir"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="dbim-pixel-medium-rgb2ir"
SWANLAB_DESCRIPTION="DBIM Pixel Medium RGB→IR"
SWANLAB_TAGS="dbim,pixel,rgb2ir"
