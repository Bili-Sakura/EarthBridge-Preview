#!/usr/bin/env bash
# EXP-0226 — CUT — SAR→IR — Medium tier (1 GPU)
#
# Same config as train_cut_sar2ir_small_8gpu.sh but single-GPU. Smaller batch.
#
# Usage:
#   bash scripts/EXP_0226_SAR2IR_Small/train_cut_sar2ir_small_1gpu.sh
...
LOG_FILE="${LOG_DIR}/train_cut_sar2ir_small_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_SAR2IR_Small/cut/sar2ir_small_512_1gpu"
NGF=64
NDF=64
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2ir-small-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→IR Small (512, ~14.1M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2ir,small,1gpu"
