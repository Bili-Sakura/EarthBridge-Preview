...
#
# Same config as train_cut_sar2rgb_small_8gpu.sh but single-GPU. Smaller batch.
#
# Usage:
#   bash scripts/EXP_0226_SAR2IR_Small/train_cut_sar2rgb_small_1gpu.sh
...
LOG_FILE="${LOG_DIR}/train_cut_sar2rgb_small_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_SAR2IR_Small/cut/sar2rgb_small_512_1gpu"
NGF=64
NDF=64
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2rgb-small-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→RGB Small (512, ~14.1M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2rgb,small,1gpu"
