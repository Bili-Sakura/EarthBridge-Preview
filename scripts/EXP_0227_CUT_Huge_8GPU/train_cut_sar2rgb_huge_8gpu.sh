#!/usr/bin/env bash
# EXP-0227 — CUT — SAR→RGB — Huge tier (8 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2rgb_huge_8gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0227_CUT_Huge_8GPU/cut/sar2rgb_huge_512_8gpu"
NGF=256
NDF=256
N_LAYERS_D=4
...
echo "EXP-0227 CUT SAR2RGB huge (8 GPU) — log: ${LOG_FILE}"
