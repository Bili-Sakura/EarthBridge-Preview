#!/usr/bin/env bash
# EXP-0227 — CUT — SAR→IR — Medium tier (8 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2ir_medium_8gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0227_CUT_Huge_8GPU/cut/sar2ir_medium_512_8gpu"
NGF=64
NDF=64
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0227-cut-sar2ir-medium-512-8gpu"
SWANLAB_DESCRIPTION="EXP-0227 CUT SAR→IR Medium (512, ~14.1M, 8 GPU, grad clip)"
SWANLAB_TAGS="cut,exp-0227,sar2ir,medium,8gpu"
...
echo "EXP-0227 CUT SAR2IR medium (8 GPU) — log: ${LOG_FILE}"
