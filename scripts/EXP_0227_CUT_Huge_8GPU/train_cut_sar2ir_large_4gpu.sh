#!/usr/bin/env bash
# EXP-0227 — CUT — SAR→IR — Large tier (4 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2ir_large_4gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0227_CUT_Huge_8GPU/cut/sar2ir_large_512_4gpu"
NGF=128
NDF=128
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0227-cut-sar2ir-large-512-4gpu"
SWANLAB_DESCRIPTION="EXP-0227 CUT SAR→IR Large (512, ~56.5M, 4 GPU, grad clip)"
SWANLAB_TAGS="cut,exp-0227,sar2ir,large,4gpu"
...
echo "EXP-0227 CUT SAR2IR large (4 GPU) — log: ${LOG_FILE}"
