#!/usr/bin/env bash
# DDBM-Pixel-Medium-0213 — SAR→IR — Pixel-space DDBM (no VAE)
...
#   CUDA_VISIBLE_DEVICES=2 bash scripts/DDBM_Pixel_Medium-0213/train_sar2ir.sh
#   # (pick 0-3 to spread stages across 4 GPUs)
#   # or multi-GPU:
#   NGPU=4 bash scripts/DDBM_Pixel_Medium-0213/train_sar2ir.sh
...
NGPU="${NGPU:-1}"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/train_sar2ir.log"
...
OUTPUT_DIR="./ckpt/DDBM_Pixel_Medium-0213/sar2ir"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="ddbm-pixel-medium-sar2ir"
SWANLAB_DESCRIPTION="DDBM Pixel Medium SAR→IR"
SWANLAB_TAGS="ddbm,pixel,sar2ir"
