#!/usr/bin/env bash
# DBIM-Pixel-Scaled-0218 — SAR→RGB — Pixel-space DBIM (no VAE)
# Huge tier, (1024, 1024) ~416M per roadmap (Stage 3) and configs/model_scaling_variants.yaml.
#
# Usage:
#   bash scripts/DBIM_Pixel_Scaled-0218/train_sar2rgb.sh
#   CUDA_VISIBLE_DEVICES=2 bash scripts/DBIM_Pixel_Scaled-0218/train_sar2rgb.sh
#   NGPU=4 bash scripts/DBIM_Pixel_Scaled-0218/train_sar2rgb.sh
...
NGPU="${NGPU:-1}"
LOG_DIR="./logs"
LOG_FILE="${LOG_DIR}/train_sar2rgb_dbim_scaled.log"
...
OUTPUT_DIR="./ckpt/DBIM_Pixel_Scaled-0218/sar2rgb"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="dbim-pixel-scaled-sar2rgb"
SWANLAB_DESCRIPTION="DBIM Pixel Scaled SAR→RGB (1024, huge)"
SWANLAB_TAGS="dbim,pixel,scaled,sar2rgb"
