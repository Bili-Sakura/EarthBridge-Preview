#!/usr/bin/env bash
# EXP-0221-v4 — DBIM — SAR→IR — 5 stages nc96 no attn (arch-search winner)
#
# Uses cuda1 config from Run 2: nc96, 5 stages, no attention, no crop_aug.
# Arch search showed this config worked well; v3 (nc64) and crop_aug failed.
#
# Usage:
#   bash scripts/EXP_0221_SAR2IR/train_dbim_sar2ir_8gpu_0221_v4.sh
#   NGPU=8 bash scripts/EXP_0221_SAR2IR/train_dbim_sar2ir_8gpu_0221_v4.sh
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2ir_8gpu_0221_v4.log"
mkdir -p "${LOG_DIR}"

# --- Model config (5 stages nc96, no attn — arch-search winner) ---
NUM_CHANNELS=96
NUM_RES_BLOCKS=2
...
PUSH_TO_HUB=true
HUB_MODEL_ID="BiliSakura/4th-MAVIC-T-ckpt-0221-v4"
OUTPUT_DIR="./ckpt/EXP_0221_SAR2IR/dbim/sar2ir_512_0221_v4"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0221-v4-sar2ir-512"
SWANLAB_DESCRIPTION="EXP-0221-v4 DBIM SAR→IR 512 (5 stages nc96 no attn, no crop_aug)"
SWANLAB_TAGS="dbim,exp-0221,v4,sar2ir,512px,nc96"
