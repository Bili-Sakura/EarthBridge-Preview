#!/usr/bin/env bash
# EXP-0221 — Arch search: cuda:1 — 5 stages no attn nc96 (more capacity)
#
# Usage:
#   bash scripts/EXP_0221_SAR2IR/train_dbim_sar2ir_arch_cuda1_5st_nc96.sh
...
LOG_FILE="${LOG_DIR}/train_early_loss_cuda1_5st_nc96.log"
mkdir -p "${LOG_DIR}"

# --- Model config: 5 stages no attn, nc96 ---
NUM_CHANNELS=96
NUM_RES_BLOCKS=2
...
PUSH_TO_HUB=false
OUTPUT_DIR="./ckpt/EXP_0221_SAR2IR/early_loss/cuda1_5st_nc96"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0221-arch-cuda1-5st-nc96"
SWANLAB_DESCRIPTION="Arch search: 5 stages 1,2,4,4,8 no attn nc96"
SWANLAB_TAGS="dbim,exp-0221,sar2ir,arch-search,5st,noattn,nc96"
