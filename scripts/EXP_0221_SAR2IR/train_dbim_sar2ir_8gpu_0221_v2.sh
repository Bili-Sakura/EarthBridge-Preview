#!/usr/bin/env bash
# EXP-0221-v2 — DBIM — SAR→IR — runtime random-crop 1024->512 — 64 channels
#
# Usage:
#   bash scripts/EXP_0221_SAR2IR/train_dbim_sar2ir_8gpu_0221_v2.sh
#   NGPU=8 bash scripts/EXP_0221_SAR2IR/train_dbim_sar2ir_8gpu_0221_v2.sh
...
LOG_FILE="${LOG_DIR}/train_dbim_sar2ir_8gpu_0221_v2.log"
mkdir -p "${LOG_DIR}"
...
PUSH_TO_HUB=true
HUB_MODEL_ID="BiliSakura/4th-MAVIC-T-ckpt-0221-v2"
OUTPUT_DIR="./ckpt/EXP_0221_SAR2IR/dbim/sar2ir_512_0221_v2"
RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-}"

# --- SwanLab ---
SWANLOG_DIR="./ckpt/swanlog"
SWANLAB_EXPERIMENT_NAME="exp-0221-v2-sar2ir-512"
SWANLAB_DESCRIPTION="EXP-0221-v2 DBIM SAR→IR 512 (runtime crop 1024→512, 64ch)"
SWANLAB_TAGS="dbim,exp-0221,v2,sar2ir,64ch"
