#!/usr/bin/env bash
# EXP-0226 — CUT — SAR→IR — Huge tier (1 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2ir_huge_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_CUT_Scaled/cut/sar2ir_huge_512_1gpu"
NGF=256
NDF=256
N_LAYERS_D=4
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2ir-huge-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→IR Huge (512, ~292.9M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2ir,huge,1gpu"
...
echo "EXP-0226 CUT SAR2IR huge (1 GPU) — log: ${LOG_FILE}"
