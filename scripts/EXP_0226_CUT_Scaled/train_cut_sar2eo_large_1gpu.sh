#!/usr/bin/env bash
# EXP-0226 — CUT — SAR→EO — Large tier (1 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2eo_large_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_CUT_Scaled/cut/sar2eo_large_256_1gpu"
NGF=128
NDF=128
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2eo-large-256-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→EO Large (256, ~56.5M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2eo,large,1gpu"
...
echo "EXP-0226 CUT SAR2EO large (1 GPU) — log: ${LOG_FILE}"
