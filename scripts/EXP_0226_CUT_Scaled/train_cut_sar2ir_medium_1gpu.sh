...
LOG_FILE="${LOG_DIR}/train_cut_sar2ir_medium_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_CUT_Scaled/cut/sar2ir_medium_512_1gpu"
NGF=64
NDF=64
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2ir-medium-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→IR Medium (512, ~14.1M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2ir,medium,1gpu"
...
echo "EXP-0226 CUT SAR2IR medium (1 GPU) — log: ${LOG_FILE}"
