#!/usr/bin/env bash
# EXP-0226 — CUT — SAR→RGB — Medium tier (4 GPU, REPA)
#
...
#
# Usage:
#   bash scripts/EXP_0226_CUT_Scaled/train_cut_sar2rgb_medium_4gpu.sh
...
LOG_FILE="${LOG_DIR}/train_cut_sar2rgb_medium_4gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_CUT_Scaled/cut/sar2rgb_medium_512_4gpu"
NGF=64
NDF=64
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2rgb-medium-512-4gpu-repa"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→RGB Medium (512, ~14.1M, 4 GPU, REPA)"
SWANLAB_TAGS="cut,exp-0226,sar2rgb,medium,4gpu,repa"
...
echo "EXP-0226 CUT SAR2RGB medium (4 GPU, REPA) — log: ${LOG_FILE}"
