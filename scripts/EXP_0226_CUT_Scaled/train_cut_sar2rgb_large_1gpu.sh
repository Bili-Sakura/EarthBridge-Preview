#!/usr/bin/env bash
# EXP-0226 — CUT — SAR→RGB — Large tier (1 GPU)
#
...
LOG_FILE="${LOG_DIR}/train_cut_sar2rgb_large_1gpu.log"
mkdir -p "${LOG_DIR}"

OUTPUT_DIR="./ckpt/EXP_0226_CUT_Scaled/cut/sar2rgb_large_512_1gpu"
NGF=128
NDF=128
N_LAYERS_D=3
...
SWANLAB_EXPERIMENT_NAME="exp-0226-cut-sar2rgb-large-512-1gpu"
SWANLAB_DESCRIPTION="EXP-0226 CUT SAR→RGB Large (512, ~56.5M, 1 GPU)"
SWANLAB_TAGS="cut,exp-0226,sar2rgb,large,1gpu"
...
echo "EXP-0226 CUT SAR2RGB large (1 GPU) — log: ${LOG_FILE}"
